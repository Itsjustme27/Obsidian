...
![Haircutfish](https://miro.medium.com/v2/resize:fill:64:64/1*7y8QySJuBrMdw2f_T7KNbg.png)





](https://medium.com/@haircutfish?source=post_page---byline--9045eb77d3c0---------------------------------------)

[Haircutfish](https://medium.com/@haircutfish?source=post_page---byline--9045eb77d3c0---------------------------------------)
...
](https://medium.com/plans?dimension=post_audio_button&postId=9045eb77d3c0&source=upgrade_membership---post_audio_button-----------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:840/0*MVlunZCB-pUZ4tx4.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*AMx1Pns_0O367TJiZod6Dg.png)

Once the URL is available, give it a click. You should be greated with the following below

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:840/1*WOqKmqcS_aAtkdbDGigRWQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*bbYFoawfTdNDHV5wZOAsrA.png)

We can analysis the sample by clicking the bluish/gray box labeled _Submit for Analysis_.

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:840/1*qcESuTFpDl9oLxndm5aOnQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*_d8I0qicM35zKhlcgAnMSQ.png)
...
![](https://miro.medium.com/v2/resize:fit:776/1*sbzCxgYpB5Agtn6KlZGYoA.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*foPSS8KxXPnGspHIxx1jYg.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*8YcuDYwEz39ePZT54WHBAA.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*hZRWWEiPjQ7U-c3bUvbgSw.png)
...
![](https://miro.medium.com/v2/resize:fit:787/1*K6mLo_DDopDseYue766ENg.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*za2aJtRNIhUG4WzTqvDLQw.png)
...
![](https://miro.medium.com/v2/resize:fit:325/1*sdzQlyP8YTLUrn_I5_fZAA.png)

Next you will need to click on the _Create Firewall Rule_ button.

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:840/1*yx_x8Joq4txL4pJ-ZAmsuw.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*xRhidi3odWxJxbHr0knRNA.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*Em3PMrk2zJhelcZXEa05ag.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*7gMdojkR1_knbpfnICNmaw.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*0GbVMOdOOJN0YQ4aIfGtow.png)
...
![](https://miro.medium.com/v2/resize:fit:773/1*iHI8y0hYF4n8IBQ1kpjQwQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*ImHOLox2A13CsRqZhYDpOA.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*L1lm_JuB02P-HrxPK3GSfQ.png)

Click on the hamburger in the top left of the window. In the drop-down you will see _DNS Filter_, click on it.

![](https://miro.medium.com/v2/resize:fit:328/1*WMXqkdPCb3-c1Lgrga4wUg.png)

Once on the _DNS Rule Manager_ page, click on the _Create DNS Rule_.

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:840/1*A0sGDPlwkJHU7I7z4ckaAQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*_DYv3-xAnLwlmfMQMmzCdA.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*OrPYhgVM7YAtABJo4RpbDg.png)

The flag can be found towards the bottom of the email. Copy and paste it into the THM answer field, then click _Submit_.

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:840/1*EYiLjTWRDqQhRwaxG61tHQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*2ar7nw6PPqJvHDDwYZxLJA.png)
...
![](https://miro.medium.com/v2/resize:fit:493/1*sKhJ6u1SslSoxZ3SJARa0Q.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*bqm6XKLKvl9v_jWAgOmeug.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*I4hoj7b_uPmSu_nSvfZqBA.png)

Click on the hamburger in the top left of the window. In the drop-down you will see _Sigma Rule Builder_, click on it.

![](https://miro.medium.com/v2/resize:fit:344/1*JGFtGR0tKiGJvN6scZuU2Q.png)
...
![](https://miro.medium.com/v2/resize:fit:625/1*qzDesGloBoGH6Rx-UhWusg.png)
...
![](https://miro.medium.com/v2/resize:fit:628/1*0ezQalXhWdiN5EQ7uPs2ag.png)
...
![](https://miro.medium.com/v2/resize:fit:613/1*XHhu8-AG5LB4nKVWqNcTdQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*fdluL4qXSVErB-LLydil_w.png)
...
![](https://miro.medium.com/v2/resize:fit:324/1*TsjyUC18-KnZ8ras60JEpw.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*RcWsHewqjcBx8Hq-hdTbkg.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*ub79mDrr2i-i06gD-djtZQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*Wz8Coy55WL086A2yEadiGw.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*riQb6DcLDBaUWOXqN8vPFg.png)

Next up is _Step 2._ We know that the _outgoing_connections.log_ file deals with

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:840/1*zjTl09MaZgxQdXROQMgv7w.png)

Lastly, we need to click on _Validate Rule_. Which will create the Sigma rule and Validate that it detects the Malware.

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:840/1*P4_p6d3shdSkNIWZJ0C0Fw.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*cLYxIis44xh7iKYNeD4bDA.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*cwXnUi5QOoRZrHzcpXieJw.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*4CO5ZLDoQB8X7vAaCLvdxg.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*UHI0Tfy9-mRThLEwGvOiuQ.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*sgD6NjpRuPg044FRunlV5g.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*RhgUSPiGBc17KcbLkW7k6Q.png)
...
![](https://miro.medium.com/v2/resize:fit:840/1*NdFxHkrWDCJOqhsBm4h_TQ.png)
